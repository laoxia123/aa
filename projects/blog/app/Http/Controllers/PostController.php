...
class PostController extends Controller
{
    ...
    public function index(){
        ...
        foreach ($posts as $key=>$post) {
            $html .= '<li><a href='.route('post.show',['post'=>$key]).'>'.$post['title'].'</a></a>';
        }
    ...
    public function create(){
       ...
       $html = <<< CREATE
          <form action="$postUrl" method="POST">
             $csrf_field
             请添加标题：<input type="text" name="title"><br/><br/>
             请添加内容：<textarea name="content" cols="30" rows="10"></textarea><br/><br/>
...
DETAIL;
    ...
    public function edit($id){
        ...
        <form action="$postUrl" method="POST">
           ...
           内容：<textarea name="content" cols="30" rows="10">{$post['content']}</textarea><br/><br/>
           <input type="submit" value="提交">
        </form>
UPDATE;
  return $html; 
